              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-white/10">
                    <th className="text-left text-xs font-semibold text-muted uppercase tracking-wider px-6 py-4">Order #</th>
                    ...
                    <th className="text-left text-xs font-semibold text-muted uppercase tracking-wider px-6 py-4">Package</th>
                    <th className="text-left text-xs font-semibold text-muted uppercase tracking-wider px-6 py-4">Status</th>
                    <th className="text-left text-xs font-semibold text-muted uppercase tracking-wider px-6 py-4">Payment</th>
                ...
                >
                  {orders.map((order, i) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <p className="text-sm text-white/80">{order.service?.title}</p>
                        <p className="text-xs text-muted">{order.project_name || order.projectType?.title}</p>
                      </td>
            ...
            {orders.map((order) => (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <span className="text-xs text-muted">{order.package?.name || "—"}</span>

...
<body>
  ...
  <div style="margin:20px 0;">
    <div style="text-align:right;">
      ...
      <div class="receipt-meta">Receipt #<?php echo e($receipt->receipt_number); ?></div>
      <div class="receipt-meta">Reference: <?php echo e($receipt->servicePayment?->reference ?? 'N/A'); ?></div>
  ...
  <table>
    ...
    <tbody>
      <tr>
        <td>Service Payment - <?php echo e($receipt->payment_type ?? 'Full'); ?></td>
        <td><?php echo e($receipt->payment_gateway ?? 'N/A'); ?></td>
        <td><?php echo e($receipt->currency ?? 'NGN'); ?></td>
        <td style="text-align:right;"><?php echo e(number_format((float)$receipt->amount_ngn, 2)); ?></td>
      </tr>
    </tbody>
  </table>
  ...
  <div class="total-box">
    ...
    <div class="amount"><?php echo e(($receipt->currency ?? 'NGN') === 'NGN' ? 'NGN ' : '$'); ?><?php echo e(number_format((float)$receipt->amount_ngn, 2)); ?></div>
  </div>

  <div class="info" style="margin-top:10px;">
    Payment Gateway: <?php echo e($receipt->payment_gateway ?? 'N/A'); ?><br>

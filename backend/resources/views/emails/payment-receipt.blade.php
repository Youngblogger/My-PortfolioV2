        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#111111;border-radius:16px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:40px;">
              <p style="font-size:16px;color:#d4af37;margin:0 0 20px;">Thank you, {{ $student_name }}!</p>
              <p style="font-size:14px;color:#a1a1aa;line-height:1.6;margin:0 0 20px;">
                Your payment for <strong style="color:#ffffff;">{{ $course_name }}</strong> has been received successfully.
              </p>
              <table width="100%" cellpadding="12" style="background-color:#1a1a2e;border-radius:12px;margin:20px 0;">
                ...
                <tr><td style="color:#a1a1aa;font-size:12px;">Reference</td><td style="color:#ffffff;font-size:12px;text-align:right;font-family:monospace;">{{ $reference }}</td></tr>
                <tr><td style="color:#a1a1aa;font-size:12px;">Receipt No.</td><td style="color:#ffffff;font-size:12px;text-align:right;font-family:monospace;">{{ $receipt_number }}</td></tr>
                <tr><td style="color:#a1a1aa;font-size:12px;">Date</td><td style="color:#ffffff;font-size:12px;text-align:right;">{{ $date }}</td></tr>
              </table>
              <a href="{{ $receipt_url }}" style="display:inline-block;background:linear-gradient(135deg,#d4af37,#f5d061);color:#0a0a0a;text-decoration:none;padding:14px 32px;border-radius:8px;font-weight:bold;font-size:14px;margin:20px 0;">View Receipt</a>
            </td>
          </tr>
        </table>
      </td>
